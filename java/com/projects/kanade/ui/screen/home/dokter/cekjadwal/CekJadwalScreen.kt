...
@Composable
fun JadwalDokterScreen(
    modifier: Modifier = Modifier,
    viewModel: JadwalDokterViewModel = viewModel(
    ...
    Column {
        ...
        Box(
            ...
            ListPasien(names = state.value.antriSuccess!!)
        }
    }
}
...
fun ListPasien(
    ...
    if (names.filter { it.nomorAntrian > 0 }.isNotEmpty()) {
        ...
        Column (
            ...
            Text(text = "Janji Temu Kosong\nSilahkan pilih ulang tanggal di kalender",
...
@Composable
fun JadwalDokterPrev() {
    //PasienJanji(pasien = "john")
}